    ...
    <div className="bg-[#f5f5f5]">
      ...
      <section className="px-10 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-8 mt-10 max-w-xl">
            ...
            <button className="mt-10 bg-black text-white px-8 py-4 rounded-xl hover:bg-gray-800 transition">
          ...
          <div className="relative">
            ...
            {/* FLOATING CARD */}
            <div className="absolute bottom-6 left-6 bg-white px-6 py-4 rounded-2xl shadow-2xl">
      ...
      <section className="px-10 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* VISION */}
          <div className="bg-white p-12 rounded-3xl shadow hover:shadow-2xl transition">
      ...
      <section className="px-10 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {values.map((item, index) => (
            ...
            <div
              key={index}
              className="bg-white p-10 rounded-3xl shadow hover:shadow-2xl transition duration-300 hover:-translate-y-2"
            >
      ...
      {/* CTA */}
      <section className="bg-[#020617] text-white py-24 text-center">
